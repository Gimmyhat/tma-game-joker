import { Card, StandardCard, Suit, TableCard, JokerOption, ValidationResult } from '../index';
import { TrickLogic } from './trick-logic';

export class SharedMoveValidator {
  /**
  ...
  static validate(
    ...
    const leadSuit = TrickLogic.getLeadSuit(table[0]);
   ...
   */
  static validateResponseToJokerHigh(
    hand: Card[],
    cardToPlay: Card,
    requestedSuit: Suit,
    trump: Suit | null,
   ...
   */
  static validateResponseToJokerLow(
    hand: Card[],
    cardToPlay: Card,
    requestedSuit: Suit,
    trump: Suit | null,
   ...
   */
  static getValidCards(hand: Card[], table: TableCard[], trump: Suit | null): Card[] {
   ...
   */
  private static hasCardOfSuit(hand: Card[], suit: Suit): boolean {
   ...
   */
  private static getCardsOfSuit(hand: Card[], suit: Suit): StandardCard[] {
    return hand.filter(
   ...
   */
  private static getHighestCard(cards: StandardCard[]): StandardCard {
