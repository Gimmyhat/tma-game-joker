...
- Для закрытия `P4-2` нужен финальный manual smoke внутри Telegram Mini App (Tournament/Referral/Leaderboard модалки).
...
```
P4-1 Release:      ✅ 100%
P4-2 Prod Smoke:   🔄 in progress (prod API smoke + frontend hotfix deployed)
P4-3 E2E/Nightly:  ⬜ 0%
P4-4 Reconnect:    ⬜ 0%
P4-5 UX Polish:    ⬜ 0%
P4-6 Admin Polish: ⬜ 0%
