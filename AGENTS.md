...
5. **Доступ к удаленному серверу** — используй команду `ssh root@hosting-vds`
6. **Деплой** — происходит автоматически после каждого коммита и пуша. У нас настроена CI/CD, которая автоматически деплоит изменения на сервер средствами GitHub Actions.
