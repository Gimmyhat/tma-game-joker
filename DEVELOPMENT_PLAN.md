...
## ✅ Структура игры (подтверждено)

| Пулька | Раздачи | Карт на игрока | Особенности |
|--------|---------|----------------|-------------|
| I | 8 | 1 → 8 | Козырь определяется верхней картой колоды |
| II | 4 | 9 | Выбор козыря игроком с правом первого хода |
| III | 8 | 8 → 1 | Козырь определяется верхней картой колоды |
| IV | 4 | 9 | Выбор козыря игроком с правом первого хода |
| **Итого** | **24** | — | — |
...
|--------|------|----------|
| 1.2 | 2026-01-22 | Q9 решён: подтверждена структура 8+4+8+4=24. Убран блокирующий баннер, добавлена таблица структуры игры, обновлён ROADMAP. Блокеров нет — можно приступать к Sprint 0. |
